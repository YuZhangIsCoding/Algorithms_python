...
"""
    ...
    def delete(self, k):
        ...
        ## Case 1 (simple case): has at most 1 child and delete the node
        ## this will only affect nodes parent
        ## Case 2: the node has 2 children, find next larger and swap the
        ## keys and delete precessor node, also only affect the deleted node's
        ## parent node.
